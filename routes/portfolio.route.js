...
portfolioRouter.get('/user/:userId',  PortfolioController.getUserPortfolio);

// GET /api/v1/portfolio/user/:userId/available-tokens - Get tokens user can withdraw
portfolioRouter.get('/user/:userId/available-tokens',  PortfolioController.getAvailableTokens);

// POST /api/v1/portfolio/validate-withdrawal - Validate if user can withdraw specific amount
portfolioRouter.post('/validate-withdrawal',  PortfolioController.validateWithdrawal);
